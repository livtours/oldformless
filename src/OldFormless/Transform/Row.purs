module OldFormless.Transform.Row where
...
import OldFormless.Internal.Transform (class Row1Cons, FromScratch, fromScratch)
import OldFormless.Types.Form (InputField(..))
